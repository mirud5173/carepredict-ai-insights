            ...
            <div className="grid grid-cols-2 gap-4 animate-scale-in">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="health-card-glow p-4 lg:p-6 text-center"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our advanced AI platform provides clinicians and patients with the
              tools needed for proactive chronic care management and improved
              health outcomes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="health-card p-6 text-center hover:scale-105 transition-smooth"
                >
                  <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                MediPredict leverages cutting-edge AI to deliver measurable
            ...
            <Card className="health-card-glow p-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Specialized views for clinicians and patients ensure everyone
                  gets the right information at the right level of detail.
                </p>
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Experience the future of healthcare with our AI-powered risk
            prediction platform.
          </p>
